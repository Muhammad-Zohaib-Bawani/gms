...
const STRINGS = {
  en: {
    ...
    guests: {
      title: ["Delegates", ""],
      sub: (n, total) => `${n} of ${total} delegates · Doha Forum 2025`,
      cols: { guest: "Delegate", tier: "Tier", country: "Country", status: "Status", arrival: "Arrival", hotel: "Hotel", accreditation: "Accreditation" },
      tier: "Tier", status: "Status",
      issued: "Issued", pending: "Pending",
    },
    invitations: {
      title: ["Invitations &", "outreach"],
      sub: "Send · track · follow up across all delegate tiers",
      templates: "Templates",
    ...
    travel: {
      ...
      cols: { guest: "Delegate", flight: "Flight", origin: "From", eta: "ETA", terminal: "Terminal", meet: "Meet & greet", car: "Car", status: "Status" },
    ...
    accreditation: {
      ...
      kpi: { issued: "Badges issued", issuedHelp: "of 2,147 expected", pendingPhoto: "Pending photo", pendingHelp: "delegates need biometric capture", securityCleared: "Security cleared", securityHelp: "background checks complete", flagged: "Flagged for review", flaggedHelp: "items requiring action" },
      queue: "Issuance queue",
      runBatch: "Run batch print",
      zones: "Access zones",
      cols: { guest: "Delegate", tier: "Tier", photo: "Photo", security: "Security", badge: "Badge", actions: "" },
    },
    seating: {
  ...
  ar: {
    ...
    guests: {
      ...
      sub: (n, total) => `${toArDigits(n)} من ${toArDigits(total)} مندوب · منتدى الدوحة ٢٠٢٥`,
      cols: { guest: "المندوب", tier: "الفئة", country: "الدولة", status: "الحالة", arrival: "الوصول", hotel: "الفندق", accreditation: "الاعتماد" },
      tier: "الفئة", status: "الحالة",
      issued: "مُصدر", pending: "في الانتظار",
    },
    invitations: {
      title: ["الدعوات", "والتواصل"],
      sub: "إرسال · متابعة · مراجعة عبر جميع فئات المندوبين",
      templates: "القوالب",
    ...
    travel: {
      ...
      cols: { guest: "المندوب", flight: "الرحلة", origin: "من", eta: "الوصول المتوقع", terminal: "المحطة", meet: "استقبال", car: "سيارة", status: "الحالة" },
    ...
    accreditation: {
      ...
      kpi: { issued: "الشارات المُصدرة", issuedHelp: "من ٢٬١٤٧ متوقعة", pendingPhoto: "بانتظار الصورة", pendingHelp: "مندوب يحتاج تسجيل حيوي", securityCleared: "موافقة أمنية", securityHelp: "اكتمال التدقيق الأمني", flagged: "للمراجعة", flaggedHelp: "بنود تحتاج إجراء" },
      queue: "طابور الإصدار",
      runBatch: "طباعة دفعة",
      zones: "مناطق الوصول",
      cols: { guest: "المندوب", tier: "الفئة", photo: "صورة", security: "أمن", badge: "الشارة", actions: "" },
    },
    seating: {
