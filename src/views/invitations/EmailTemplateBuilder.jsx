...
export function previewHtml(body) {
  ...
  return withInertLink.replace(
    ...
    (match, tag, token) => (tag ? tag : (
      `<span style="background:rgba(141,1,52,0.08);color:#158ba8;border:1px dashed rgba(141,1,52,0.35);` +
        ...
        <div style={{ overflowY: 'auto', flex: 1, background: '#fff' }}>
          <div style={{ padding: '20px 24px 0' }}>
            ...
            <div style={{ display: 'flex', alignItems: 'flex-start', gap: 12, marginTop: 18 }}>
              <div style={{
                width: 40, height: 40, borderRadius: '50%', background: '#158ba8', color: '#fff',
        ...
        <div style={{
          ...
          <button
            ...
            style={{
              ...
              border: 'none', background: '#158ba8', color: '#fff',
            }}
          >
            {isAr ? 'إغلاق' : 'Close'}
          </button>
