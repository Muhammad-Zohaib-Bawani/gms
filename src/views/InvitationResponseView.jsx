...
export default function InvitationResponseView({ token, lang }) {
  ...
  const T = isAr ? {
    ...
    acceptedSub: 'يسعدنا استقبالك — سيتواصل معك فريق التنسيق قريباً بكل التفاصيل.',
    ...
    appTitle: 'خطوة أخيرة — نزّل تطبيق كبار الضيوف',
    ...
    accepted: 'Wonderful — your attendance is confirmed.',
    ...
    appTitle: "One more thing — get the VIP Guest App",
