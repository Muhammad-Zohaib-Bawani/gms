...
export default function AuthView() {
  const { signIn, signInWithMicrosoft, authError } = useAuth();
    ...
    <div className="login-shell">
      ...
      <div className="login-form-side">
        ...
        >
          ...
          {/* Entra mode shows only the SSO button: the backend rejects portal
              password logins outright while Auth:Mode is EntraId, so rendering the
              password form would be offering a door that is bolted shut. */}
          {ENTRA_ENABLED ? (
            <>
              <Button
                type="button"
              ...
              {/* authError is a failed exchange from a redirect return — it
                  happened before this view mounted, so it has no local catch. */}
              {(errors.sso || authError) && (
                <div
