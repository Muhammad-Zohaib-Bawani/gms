    ...
    <div>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(4,1fr)", gap: 12, marginBottom: 20 }}>
        {[
          ...
          { label: STR.remaining,   val: fmtQAR(totalRemain, lang), delta: isAr ? "متاح للصرف" : "Available to spend", color: "#158ba8", spark: [80,75,68,60,55,48,42,38] },
        ].map((k, i) => (
          ...
          <div style={{ display: "flex", gap: 6 }}>
            {Object.entries(STR.filters).map(([key, label]) => (
              <button key={key}
                ...
                style={{ padding: "3px 10px", fontSize: 11, background: activeFilter === key ? "rgba(0, 98, 123,0.15)" : undefined, borderColor: activeFilter === key ? "rgba(0, 98, 123,0.4)" : undefined }}
