...
export default function VenueToolbar({
  ...
  canCloneVenue, onCloneVenueClick, canAddVenue = true,
    ...
    <div className="card" style={{ padding: '10px 14px', marginBottom: 14 }}>
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 8, flexWrap: 'wrap', rowGap: 10 }}>
        ...
        {activeVenue?.venueType && activeVenue.venueType !== 'general' && (
          <span style={{ fontSize: 11, fontWeight: 600, color: 'var(--accent)', background: 'rgba(0, 98, 123,0.1)', border: '1px solid rgba(0, 98, 123,0.25)', borderRadius: 20, padding: '3px 10px', flexShrink: 0, textTransform: 'capitalize' }}>
