...
export const ICON_PATHS = {
  ...
  mapPin: <><path d="M12 21s7-5.5 7-11a7 7 0 10-14 0c0 5.5 7 11 7 11z"/><circle cx="12" cy="10" r="2.5"/></>,
  ...
  // Sidebar-rail toggle: the standard "panel with a left column" glyph, with an
  // inner chevron for direction. `panelCollapse` = shrink the rail to icons,
  // `panelExpand` = bring the labels back.
  panelCollapse: <><rect x="3" y="4" width="18" height="16" rx="2"/><path d="M9 4v16"/><path d="M16.5 9.5 14 12l2.5 2.5"/></>,
  panelExpand: <><rect x="3" y="4" width="18" height="16" rx="2"/><path d="M9 4v16"/><path d="M14 9.5 16.5 12 14 14.5"/></>,
